...
public class MovingPlatform : MonoBehaviour
{
    ...
    [SerializeField] float moveSpeed;// this will be used to determine how fast the platforms will move by multiplying by the lerp values ~~Karahan
    ...
    private void Update()
    {
        ...
        {
            lerpPosition2 += Time.deltaTime * moveSpeed;
